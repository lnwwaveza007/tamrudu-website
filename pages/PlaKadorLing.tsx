        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 md:order-1 relative group">
            <div className="aspect-square bg-indigo-50 rounded-full overflow-hidden border-4 border-white shadow-lg relative z-10">
              <img src="https://www.nstda.or.th/agritec/wp-content/uploads/2021/06/textile-suannok-1.jpg" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" alt="Indigo Dye" />
            </div>
