    ...
    <div className="pt-20 min-h-screen flex flex-col">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          <motion.span
            className="block text-mangrove text-sm md:text-base font-bold tracking-[0.3em] uppercase mb-4"
          ...
          <motion.h1
            className="font-serif text-5xl md:text-7xl lg:text-8xl text-indigo-deep leading-tight mb-8"
          ...
          <motion.p
            className="font-sans font-light text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-12"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-24 px-6 md:px-12 bg-white/50">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <Reveal delay={0.2} direction="up">
            <motion.div
              className="text-center p-6 border border-transparent hover:border-indigo-deep/10 transition-colors duration-500 rounded-lg"
              whileHover={{ y: -10 }}
            >
